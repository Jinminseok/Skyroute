...
BEGIN
  ...
  ---------------------------------------------------------------------------
  -- 1) 등록 탑승객 SAVED_PASSENGER
  --    ※ 회원당 1건(본인 여권)만 허용 - uq_saved_passenger_member UNIQUE 제약
  --    마이페이지에서 등록/수정하며, 예약 화면에서는 불러오기(읽기)만 한다.
  ---------------------------------------------------------------------------
  INSERT INTO SAVED_PASSENGER (member_id, name, birth_date, phone, gender,
                               passport_no, passport_expiry)
  VALUES (v_user1, 'HONG GILDONG', DATE '1990-05-15', '010-1111-2222', 'M',
          'M11111111', DATE '2033-05-14');

  INSERT INTO SAVED_PASSENGER (member_id, name, birth_date, phone, gender,
                               passport_no, passport_expiry)
  VALUES (v_user2, 'KIM YOUNGHEE', DATE '1988-11-03', '010-4444-5555', 'F',
          'M22222222', DATE '2031-10-20');
  ...
  INSERT INTO BOOKING_PASSENGER (booking_id, name, birth_date, phone, gender)
  VALUES (v_bkA, '홍길동', DATE '1990-05-15', '010-1111-2222', 'M')
  ...
  INSERT INTO BOOKING_PASSENGER (booking_id, name, birth_date, phone, gender)
  VALUES (v_bkB, '홍길순', DATE '1993-08-21', '010-1111-3333', 'F')
  ...
  INSERT INTO BOOKING_PASSENGER (booking_id, name, birth_date, phone, gender)
  VALUES (v_bkC, '김영희', DATE '1988-11-03', '010-4444-5555', 'F')
